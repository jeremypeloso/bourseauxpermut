  ...
  return (
    <div className="w-full text-[#141A26] bg-white">
      ...
      <section id="cta" className="py-20 text-center text-white bg-gradient-to-br from-bleu to-bleud"><W>
        ...
        <div className="flex flex-wrap gap-3 justify-center"><Btn m="signup" t="Créer mon compte" cls="px-7 py-4 rounded-2xl text-[16px] font-bold text-navy bg-white" /><Btn m="login" t="J'ai déjà un compte" cls="px-7 py-4 rounded-2xl text-[16px] font-bold text-white bg-white/10 border border-white/25" /></div>
      </W></section>
