      ...
      <section id="permut" className="py-24 bg-[#0B1426] text-white">
        <W cls="grid md:grid-cols-[1fr_1.1fr] gap-14 items-center">
          <div>
            ...
            <p className="text-[17px] text-white/70 mt-3 leading-relaxed">Hors Boîte croise les souhaits en silence et ferme les cycles à 2, 3 ou 4 : vous allez à Nice, Nice va à Toulouse, Toulouse vient chez vous. Et si vous préférez chercher vous-même, les annonces de permutation sont là, anonymes, classées par département.</p>
